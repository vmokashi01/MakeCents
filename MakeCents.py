...
for day in days:
	temp_historic_rate_data = xecd.historic_rate(day, "00:00", 'CAD', currencyTo, amount)
	print(temp_historic_rate_data)
	for currency in currencies:
		temp_historic_rate = temp_historic_rate_data['to'][currencies.index(currency)]['mid']
		print(temp_historic_rate)
		db.child("Historical_data").push({
			'date': day,
			'rate': temp_historic_rate
		})

order_real = ['JPY', 'EUR', 'GBP', 'USD', 'CNH']
